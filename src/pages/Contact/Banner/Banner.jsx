...
const Banner = () => {
  return (
    <div className="md:ml-10 lg:ml-32 mt-20  h-[300px] lg:h-[600px]  flex flex-col items-start justify-center hero h-[100vh">
      <div className=" flex items-center justify-between">
        <div className=" text-white w-full">
          <h1 className="text-6xl text-white">Contact</h1>
        </div>
      </div>
      <div className="mt-20 md:mt-32 flex flex-col lg:flex-row justify-center items-baseline lg:gap-56  ">
